...
class ArxivBrowser:
    ...
    def __init__(self, downloads_dir: str = "downloads") -> None:
        ...
        Args:
            downloads_dir: Directory to use for temporary downloads if needed.
        """
    ...
    def search(
        ...
        Args:
            ...
            start: Pagination start index (0-based) across the full result set.
            categories: Optional list of arXiv category filters (e.g., ["cs.AI"]).
            date_from_days: If provided, limit results to within the last N days.
    ...
    def iter_all(
        ...
        Args:
            query: Free-text search query.
            categories: Optional list of arXiv category filters.
            date_from_days: If provided, limit results to within the last N days.
            chunk_size: Number of results fetched per request.
            limit: If provided, stop after yielding at most `limit` results.
    ...
    def search_all(
        ...
        Args:
            ...
            date_from_days: If provided, limit results to within the last N days.
            chunk_size: Number of results fetched per request.
            limit: If provided, stop after collecting at most `limit` results.
    ...
    def get(self, arxiv_id: str) -> Optional[ArxivPaper]:
        ...
        Returns:
            The corresponding `ArxivPaper` instance if found; otherwise None.
        """
